...
!define PRODUCT_NAME "HCL-ODA-TestPAD_x64 ${VersionBuild}"
;To display text on header of welcome page
!define PRODUCT_HEADER_NAME "HCL-ODA-TestPAD_x64"
...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\HCL-ODA-TestPAD_x64.exe"
...
InstallDir "$PROGRAMFILES\Hilti\HCL-ODA-TestPAD_x64"
