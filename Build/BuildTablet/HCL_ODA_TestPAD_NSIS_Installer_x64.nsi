...
!define PRODUCT_NAME "HCL-ODA-TestPAD (64-bit) ${VersionBuild}"
;To display text on header of welcome page
!define PRODUCT_HEADER_NAME "HCL-ODA-TestPAD (64-bit)"
!define PRODUCT_PUBLISHER "Hilti"
!define PRODUCT_INFO_REGKEY "Software\Hilti\${ApplicationName}"
!define PRODUCT_UNINST_REGKEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\cb63614e-c3ea-4b28-b7ec-1388c00ff14d"
...
VIAddVersionKey "FileDescription" "Installer for HCL-ODA-TestPAD_x64."
...
;Application Name
!define ApplicationName "HCL-ODA-TestPAD_x64"
; Uninstaller pages
...
InstallDir "$PROGRAMFILES64\Hilti\HCL-ODA-TestPAD"
...
!macro CHECKRUNNINGAPP un
  Function ${un}checkForRunningApp
    ...
    ${If} $R0 == 0
        ...
        DetailPrint "Waiting for HCL-ODA-TestPAD_x64 to close"
    Sleep 3000
${EndIf}    
${nsProcess::Unload}
  FunctionEnd
...
Section "MainSection" SEC02
  ...
  File "..\${SourceMainDir}\HCL-ODA-TestPAD.dll"
  ...
  File "..\${SourceMainDir}\Microsoft.Extensions.Diagnostics.Abstractions.dll"
  ...
  File "..\${SourceMainDir}\Prism.Container.Abstractions.dll" 
  File "..\${SourceMainDir}\Prism.dll" 
  File "..\${SourceMainDir}\Prism.Events.dll"
  ...
  File "..\${SourceMainDir}\System.Diagnostics.DiagnosticSource.dll"
  File "..\${SourceMainDir}\System.IO.Pipelines.dll"
