...
REM set VERSION_BUILD=0.%date:~10,4%.%date:~4,2%.%date:~7,2%
...
"%PFDir%\NSIS\makensis.exe" /V3 /DVersionBuild=%VERSION_BUILD% /DSourceMainDir=%BUILD_CONFIG% /DFileVersion=%VERSION_BUILD% /DSourceSubDir= "HCL_ODA_TestPAD_NSIS_Installer_x32.nsi"
