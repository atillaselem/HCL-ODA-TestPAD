...
public partial class TvPropertiesPalette : UserControl
{
    ...
    private IOdaSectioning _renderArea;
    ...
    public TvPropertiesPalette()
    {
        DataContext = this;
        InitializeComponent();
        _vm = MainWindow.ViewModel;
    }

    public void InitializePalette(OdTvGsDeviceId devId, IOdaSectioning renderArea)
    {
        _devId = devId;
    ...
    private void OnOffFPS_Click(object sender, RoutedEventArgs e)
    {
        ...
        _vm.AppearanceOpt = cb.IsChecked == true ?
            _vm.AppearanceOpt | MainWindowViewModel.AppearanceOptions.FPSEnabled
            : _vm.AppearanceOpt ^ MainWindowViewModel.AppearanceOptions.FPSEnabled;
    }
    ...
    private void OnOffWcs_Click(object sender, RoutedEventArgs e)
    {
        ...
        //    return;
        //_vm.AppearanceOpt = cb.IsChecked == true ?
        //    _vm.AppearanceOpt | MainWindowViewModel.AppearanceOptions.WCSEnabled
        //    : _vm.AppearanceOpt ^ MainWindowViewModel.AppearanceOptions.WCSEnabled;
    }

    private void OnOffViewCube_Click(object sender, RoutedEventArgs e)
    {
        //CheckBox cb = sender as CheckBox;
        //if (cb == null)
        //    return;
        //_vm.AppearanceOpt = cb.IsChecked == true ?
        //    _vm.AppearanceOpt | MainWindowViewModel.AppearanceOptions.ViewCubeEnabled
        //    : _vm.AppearanceOpt ^ MainWindowViewModel.AppearanceOptions.ViewCubeEnabled;
    }
    ...
    private void OnOffAnimation_Click(object sender, RoutedEventArgs e)
    {
        ...
        //    return;
        //_vm.AppearanceOpt = cb.IsChecked == true ?
        //    _vm.AppearanceOpt | MainWindowViewModel.AppearanceOptions.UseAnimation
        //    : _vm.AppearanceOpt ^ MainWindowViewModel.AppearanceOptions.UseAnimation;
    }
