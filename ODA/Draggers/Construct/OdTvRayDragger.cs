...
public class OdTvRayDragger : OdTvBaseConstructDragger
{
    public OdTvRayDragger(OdTvGsDeviceId tvDeviceId, OdTvModelId tvDraggersModelId, OdTvModelId activeModel)
    ...
    public override void UpdateGeometry(bool bCreate, bool bFromNextPoint)
    {
        ...
        if (bCreate || _newGeometryId == null)
        {
            ...
            _entityId = modelPtr.appendEntity();
            {
                ...
                rc = OdTvResult.tvOk;
                //create ray
                _newGeometryId = entityNewPtr.appendInfiniteLine(_clickedPts[0], _clickedPts[1], OdTvInfiniteLineData_Type.kRay, ref rc);
        ...
        {
            OdTvInfiniteLineData rayPtr = _newGeometryId.openAsInfiniteLine();
            if (rayPtr != null)
            {
                rayPtr.setSecond(_clickedPts[1]);
                rayPtr.Dispose();
            }
        }
