...
{
    public TvDatabaseProperties(OdTvGsDeviceId devId, IOdaSectioning renderArea)
    ...
    StretchingTreeViewItem AddImportNode(string text, Grid grid, int[] arr)
    {
        ...
        StretchingTreeViewItem tItm = new StretchingTreeViewItem
        {
            Header = CreateGridWithElements(2, lbl, tb)
            ,
