...
class TvDeviceProperties : BasePaletteProperties
{
    ...
    public TvDeviceProperties(OdTvGsDeviceId devId, IOdaSectioning renderArea)
    ...
    private void TvDeviceProperties_Click(object sender, RoutedEventArgs e)
    {
    ...
    private void TvDeviceLutPalette_Click(object sender, RoutedEventArgs e)
    {
        CheckBox cb = sender as CheckBox;
        if (cb == null)
            return;
