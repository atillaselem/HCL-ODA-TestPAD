...
public class TvTreeItem : TreeViewItem
{
    ...
    public TvTreeItem(string name, BitmapImage img, TvTreeItem parent, TvNodeData nodeData, MainWindowViewModel vm)
    {
            ...
            || NodeData.Type == TvBrowserItemType.Geometry)
        {
            ...
            {
                AddContextMenuItem("Isolate", Application.Current.Resources["MbIsolateImg"] as BitmapImage, new Size(16, 12));
                AddContextMenuItem("Hide", Application.Current.Resources["MbHideImg"] as BitmapImage, new Size(17, 12));
            }
            else
                AddContextMenuItem("Unisolate", Application.Current.Resources["MbUnisoImg"] as BitmapImage, new Size(17, 11));
        }

        Selected += TvTreeItem_Selected;
    }
